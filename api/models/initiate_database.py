...
engine = create_engine('postgresql://' + settings["postgreql_username"] + ':' + settings["postgreql_password"] + '@' + settings["postgreql_host"] + '/' + settings["postgres_db"] + '?client_encoding=utf8', pool_pre_ping=True, pool_recycle=60, encoding='utf8')
